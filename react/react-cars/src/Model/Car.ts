export class Car {
    ...
    public shnat_yitzur: String;
    public tokef_dt: String;
    public baalut: String;
    public tzeva_rechev: String;
    public kinuy_mishari: String;

    constructor(mispar_rechev:String, tozeret_nm:String, shnat_yitzur:String, tokef_dt:String, baalut:String, tzeva_rechev:String, kinuy_mishari:String) {
